...
return (
    ...
    <IonContent className="page-background" fullscreen>
      ...
      {/*Need to polish the guides, add favoriting, and orginze guides by type. May want to add a guide section that's nothing but advice */}
